    ...
    <>
      <DashboardContent>
        ...
        <Grid container spacing={2}>
          ...
          <Grid xs={12}>
            <Alert severity="info">
              Si vous êtes déjà client, vous avez la possibilité de renouveler votre abonnement en
              vous connectant à notre centre d&apos;achats{' '}
              <Link href="https://repfonepro.fr/" target="_blank" rel="noopener">
                Acheter un pack
              </Link>{' '}
