...
import MethodeCard from './components/methode-card'

export default function MethodesDnd({ deleteData, data, addData, editData }) {
  ...
  return (
    ...
    <Box
      ...
      >
        {data.map((item) => <MethodeCard deleteData={deleteData} item={item} editData={editData}/>)}
        <MethodeCard add openAdd={openAdd}/>
    </Box>
