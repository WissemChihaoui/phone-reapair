...
export default function TypeDnd({ deleteData, data, addData, editData }) {
  ...
  return (
    ...
    <Box
      ...
      >
        {data.map((item) => <TypeCard deleteData={deleteData} item={item} editData={editData}/>)}
        <TypeCard add openAdd={openAdd}/>
    </Box>
