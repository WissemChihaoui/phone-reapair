...
export default function TypeCard({ item, add, openAdd, deleteData, editData }) {
...
<Dialog open={openEdit.value} onClose={openEdit.onFalse}>
        <DialogTitle>Modifier ce type de client</DialogTitle>

        <DialogContent>
          
          <Alert sx={{ mb : 2}} severity='warning'>
            Veuillez vérifier que le libellé de type du client n&apos;existe pas
          </Alert>

          <TextField value={nameField} onChange={(e)=> setNameField(e.target.value)} autoFocus fullWidth type="text" variant="outlined" label="Libellé" />
        </DialogContent>
