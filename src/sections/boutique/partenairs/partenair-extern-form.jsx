...
export default function PartenairExternForm({open, onClose, currentUser}) {
    ...
    const defaultValues = useMemo(
        () => ({
          ...
          fixNumber: currentUser?.fixNumber || '',
    ...
    >
        <Form methods={methods} onSubmit={onSubmit}>
            <DialogTitle>{currentUser ? 'Modifier partenaire externe':'Ajouter partenaire externe'}</DialogTitle>
            <DialogContent>
                <Box
                    rowGap={3}
                    columnGap={2}
