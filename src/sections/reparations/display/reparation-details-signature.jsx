        ...
        <Card>
            ...
            <Stack sx={{p:3}}>
                ...
                <Stack display="flex" flexDirection="row" gap={1} width="100%" mt={3}>
                    <Button variant='contained' onClick={save} color='primary' sx={{ width: '100%' }}>Enregistrer</Button>
                    <Button variant='contained' onClick={clear} sx={{ width: '100%' }}>Réinitialisation</Button>
                </Stack>
            </Stack>
        </Card>
    </>
