...
const TABLE_HEAD = [
  ...
  { id: 'orderNumber', label: '#Réf', width: 88 },
  { id: 'name', label: 'Technicien' },
  { id: 'rep', label: 'Réparation' },
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        content={
          <>
            Êtes-vous sûr de vouloir supprimer <strong> {table.selected.length} </strong> lignes?
          </>
        }
        action={
          <Button
