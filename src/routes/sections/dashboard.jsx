...
const Inventaire = lazy(() => import ('src/pages/dashboard/stock/inventaire'));
const AddInventaire = lazy(() => import ('src/pages/dashboard/stock/addInventaire'));
const EditInventaire = lazy(() => import ('src/pages/dashboard/stock/editInventaire'));
...
const Suivre = lazy(() => import('src/pages/dashboard/ventes/abonnements'))
const AddVente = lazy(() => import('src/pages/dashboard/ventes/add'))
const Devis = lazy(() => import('src/pages/dashboard/ventes/devis'))
const EditVente = lazy(() => import('src/pages/dashboard/ventes/edit'))
const DisplayVente = lazy(() => import('src/pages/dashboard/ventes/display'))
...
const InvoicePrint = lazy(() => import('src/pages/dashboard/invoice/print'))
...
const ExportComptableFamille = lazy(() => import('src/pages/dashboard/caisse/export-comptable-famille'))
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {element: <Inventaire />, path:'inventaire'},
          {element: <AddInventaire />, path:'inventaire/add'},
          {element: <EditInventaire />, path:'inventaire/:id/edit'},
      ...
      },
      {
        ...
        children: [
          ...
          {element: <DisplayVente />, path: ':id/display'},
        ]
      },
      {
        path: 'rachat',
      ...
      },
      {
        ...
        children: [
          ...
          {element: <ExportComptableFamille />, path: 'export-comptable-famille'},
