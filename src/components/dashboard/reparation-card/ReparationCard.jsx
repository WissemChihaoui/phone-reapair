...
export default function ReparationCard({ color = 'success', icon, percent, title, total }) {
      ...
      <div>
        ...
        >
          <Box sx={{ p: 1, maxWidth: 280 }}>
            <Typography variant="body2">Voir toutes les réparations</Typography>
          </Box>
        </CustomPopover>
      </div>
      <div>
        ...
        >
          <Box sx={{ p: 1, maxWidth: 280 }}>
            <Typography variant="body2">Ajouter Réparation</Typography>
          </Box>
        </CustomPopover>
      </div>
    </Box>
